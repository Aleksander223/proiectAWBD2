...
import com.proiect2.product.exceptions.ExceptionPattern;
...
public class CustomizedExceptionHandler  extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid
        ...
        ExceptionPattern exception = new ExceptionPattern(new java.util.Date(), ex.getMessage(), request.getDescription(true));
